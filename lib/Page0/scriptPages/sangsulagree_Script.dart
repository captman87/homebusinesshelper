        ...
        child: ListView(
          children: [
            Container(
              ...
              child: Column(
                children: [
                  CustomText('<cr>주민번호 수집시\n반드시 상품설계동의 (본인 녹취) 필수!!</cr>',
                      TextAlign.center, 17),
                  Padding(padding: EdgeInsets.only(top: 10.h)),
                  CustomText('<cr>가족의 경우에도 절대 불가!!\n상담원 본인/가족도 불가!!</cr>',
                      TextAlign.center, 17),
                ],
              ),
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(padding: EdgeInsets.only(top: 20.h)),
                  CustomText('앞서 동의해주신 정보에 건강정보와 주민번호가 포함되는 것에 동의하세요?',
                      TextAlign.left, 18),
                  CustomText('<cr>[예 동의필수]</cr>', TextAlign.end, 18),
                  Padding(padding: EdgeInsets.only(top: 20.h)),
                  CustomText('네, 주민번호를 말씀해주세요.', TextAlign.left, 18),
